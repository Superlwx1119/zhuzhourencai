...
<!--
  ...
  icon: 这种基本用于表格操作里面的图标按钮
    ...
    personnel 签约 signing 续期签约 addSigning 解约 termination 延期 postpone 复制 copy 资料 document
-->
<template>
  <el-button
    v-if="!icon"
  ...
  data() {
    return {
      ...
      operationTypeArr: [
        ...
        { type: 'template', title: '模板下载', eleType: 'primary' },
      ...
      iconArr: [
        ...
        { icon: 'document', title: '资料', iconSvg: 'el-icon-document', isFontSize: true, eleType: 'primary' },
        { icon: 'signing', title: '签约', iconSvg: 'el-icon-document-checked', isFontSize: true, eleType: 'primary' },
        { icon: 'addSigning', title: '续期签约', iconSvg: 'el-icon-document-add', isFontSize: true, eleType: 'primary' },
        { icon: 'termination', title: '解约', iconSvg: 'el-icon-document-delete', isFontSize: true, eleType: 'primary' },
        { icon: 'postpone', title: '延期', iconSvg: 'el-icon-circle-plus-outline', isFontSize: true, eleType: 'primary' },
        { icon: 'stop', title: '停止', iconSvg: 'el-icon-circle-close', isFontSize: true, eleType: 'danger' },
        { icon: 'print', title: '打印', iconSvg: 'el-icon-printer', isFontSize: true, eleType: 'primary' },
        { icon: 'copy', title: '复制', iconSvg: 'el-icon-document-copy', isFontSize: true, eleType: 'primary' },
        ...
        { icon: 'export', title: '导出', iconSvg: 'download', eleType: 'primary' },
        ...
        { icon: 'lock', title: '锁定', iconSvg: 'suoding', eleType: 'danger' }
      ]
    }
  },
  computed: {
